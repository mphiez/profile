...
<head>
  ...
  <title>ForestCode - Profile</title>
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="../../index2.html" class="navbar-brand"><b>Forest</b>Code</a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown messages-menu">
              ...
              <ul class="dropdown-menu">
                    ...
                    <li><!-- start message -->
                      <a href="#">
                        ...
                        <h4>
                          ...
                          <small><i class="fa fa-clock-o"></i> <?php echo $row->datetime;?></small>
                        </h4>
                        <!-- The message -->
                ...
                <li class="footer"><a href="<?php echo base_url()?>index.php/profile/load">See All Messages</a></li>
              </ul>
            </li>
			<?php } ?>
            <!-- /.messages-menu -->
                ...
                <li>
                  ...
                  <ul class="menu">
                    <li><!-- start notification -->
                      <a href="#">
                        <i class="fa fa-users text-aqua"></i> Please leave comment or critic for my profile page
                      </a>
                    </li>
                    <!-- end notification -->
                  </ul>
