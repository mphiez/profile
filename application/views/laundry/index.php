...
<div class="content">
  ...
  <script>
	...
	$.ajax({
		url: '<?php echo base_url()?>index.php/laundry/information',
		type: "POST",
		data: {},
	...
	$('#package').click(function(){
		...
		$.ajax({
			url: '<?php echo base_url()?>index.php/laundry/paket',
	...
	$('#transaction').click(function(){
		...
		$("#body-content").slideUp();
		$.ajax({
			url: '<?php echo base_url()?>index.php/laundry/transaksi',
			beforeSend: function( xhr ) {
				$('#onprogres').html('<i class="fa fa-loading"></i>');
			},
			type: "POST",
	...
	$('#pesan').click(function(){
		var urlx = '<?php echo base_url()?>index.php/laundry/mail';
		if('<?php echo $this->session->userdata('jabatan')?>' == '0'){
			urlx = '<?php echo base_url()?>index.php/laundry/list_mail';
		}
		document.getElementById('onprogres').innerHTML = '';
		$('#get_new').val('1');
		$("#body-content").slideUp();
	...
	$('#notification').click(function(){
		...
		$("#body-content").slideUp();
		$.ajax({
			url: '<?php echo base_url()?>index.php/laundry/notification',
			beforeSend: function( xhr ) {
				$('#onprogres').html('<i class="fa fa-loading"></i>');
			},
			type: "POST",
	...
	function edit_user(x = null){
		...
		$("#body-content").slideUp();
		$.ajax({
			url: '<?php echo base_url()?>index.php/laundry/setting',
			beforeSend: function( xhr ) {
				$('#onprogres').html('<i class="fa fa-loading"></i>');
			},
			type: "POST",
	...
	$('#create').click(function(){
		...
		$("#body-content").slideUp();
		$.ajax({
			url: '<?php echo base_url()?>index.php/laundry/create',
			beforeSend: function( xhr ) {
				$('#onprogres').html('<i class="fa fa-loading"></i>');
			},
			type: "POST",
	...
	$('#user').click(function(){
		...
		$("#body-content").slideUp();
		$.ajax({
			url: '<?php echo base_url()?>index.php/laundry/user',
			beforeSend: function( xhr ) {
				$('#onprogres').html('<i class="fa fa-loading"></i>');
			},
			type: "POST",
	...
	$('#timeline').click(function(){
		...
		$("#body-content").slideUp();
		$.ajax({
			url: '<?php echo base_url()?>index.php/laundry/timeline',
			beforeSend: function( xhr ) {
				$('#onprogres').html('<i class="fa fa-loading"></i>');
			},
			type: "POST",
	...
	function load_notif(){
		/* $.ajax({
			url: '<?php echo base_url()?>index.php/laundry/tot_message',
			type: "POST",
			data: {},
			success: function(datax) {
				if(datax > 0){
		...
		$.ajax({
			url: '<?php echo base_url()?>index.php/laundry/tot_notif',
			type: "POST",
			data: {},
			success: function(datax) {
